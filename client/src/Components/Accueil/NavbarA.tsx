    ...
    <header className="w-full bg-white shadow-md fixed top-0 left-0 z-50">
      ...
      >
        ...
        <nav className="space-y-4 text-sm text-gray-800">
          {/* VOS BESOINS */}
          <div>
            <p className="font-bold text-xs text-gray-500">VOS BESOINS</p>
          ...
          {/* VOTRE PROFIL */}
          <div>
            <p className="font-bold text-xs text-gray-500 mt-4">VOTRE PROFIL</p>
            <ul className="ml-2 space-y-1">
          ...
          {/* MIEUX CHOISIR */}
          <div>
            <p className="font-bold text-xs text-gray-500 mt-4">MIEUX CHOISIR</p>
            <ul className="ml-2 space-y-1">
          ...
          {/* PRATIQUE */}
          <div>
            <p className="font-bold text-xs text-gray-500 mt-4">PRATIQUE</p>
            <ul className="ml-2 space-y-1">
            ...
            {isAuthenticated ? (
              ...
              <div className="space-y-2">
                ...
                <Link
                  to="/register"
                  onClick={toggleMenu}
                  className="block w-full text-center px-4 py-2 rounded border border-blue-600 text-blue-600 hover:bg-blue-50"
                >
                  Créer un compte
                </Link>
              </div>
