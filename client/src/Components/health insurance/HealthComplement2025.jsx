import {healthSections} from "../../assets/Data/healthSections"
      ...
      <div className="max-w-3xl mx-auto p-4 bg-gray-50">
        ...
        {healthSections.map((section) => (
          <div key={section.id} className="flex gap-4 bg-white p-4 rounded-lg shadow-md mb-4">
            ...
            <div className="w-2/3">
              <a href={`health/${section.id}`} className="text-lg font-semibold text-blue-600 hover:text-blue-800 mb-2 block">
                {section.title}
              </a>
