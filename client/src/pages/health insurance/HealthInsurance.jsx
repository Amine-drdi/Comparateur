...
import InsuranceBrands from "../../Components/health insurance/InsuranceBrands";
import CustomerReviews from "../../Components/health insurance/CustomerReviews";
import HealthInsuranceCTA from "../../Components/health insurance/HealthInsuranceCTA"
import HealthInsuranceCTA2 from "../../Components/health insurance/HealthInsuranceCTA2"
import HealthInsuranceCTA3 from "../../Components/health insurance/HealthInsuranceCTA3"
import MutuelleComparator from "../../Components/health insurance/MutuelleComparator";
import MutuelleProfileSelector from "../../Components/health insurance/MutuelleProfileSelector";
import ComplémentaireSantéPage from "../../Components/health insurance/ComplémentaireSantéPage ";
import MutuelleQuestionsNumerated from "../../Components/health insurance/MutuelleQuestionsNumerated ";
import HealthComplement2025 from "../../Components/health insurance/HealthComplement2025";
import HealthGuides from "../../Components/health insurance/HealthGuides";
import HealthNewsComponent from "../../Components/health insurance/HealthNewsComponent ";
      ...
      <div className="md:w-2/3">
        ...
        <ul className="text-blue-800 space-y-2 mb-4">
          <li className="flex items-center">
            <span className="mr-2">✨</span> Les offres de 35 mutuelles & assureurs santé comparées
          </li>
          <li className="flex items-center">
