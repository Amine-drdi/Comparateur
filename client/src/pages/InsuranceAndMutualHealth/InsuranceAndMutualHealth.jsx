    ...
    Obtenir un devis
          ...
          <div className="mb-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-blue-400 hover:text-blue-500">Mutuelle d'entreprise</a></li>
              <li><a href="#" className="text-blue-400 hover:text-blue-500">Besoin optique</a></li>
              <li><a href="#" className="text-blue-400 hover:text-blue-500">Besoin dentaire</a></li>
